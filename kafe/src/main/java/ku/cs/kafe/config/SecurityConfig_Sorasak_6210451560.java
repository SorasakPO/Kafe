...
import ku.cs.kafe.service.UserDetailsServiceImp_Sorasak_6210451560;
...
@Configuration
@EnableWebSecurity
public class SecurityConfig_Sorasak_6210451560 {


    @Autowired
    private UserDetailsServiceImp_Sorasak_6210451560 userDetailsService;
